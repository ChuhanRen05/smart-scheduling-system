...
def questionAnswering(tokenized_userinput):
    ...
    if most_similar_sentence_index == -1 and most_similar_sentence == None:
        ...
        print(textTokenize.get_answer_csv("mentalhealth.csv", most_similar_sentence_index))
def greeting_message():
    print("Hello! I'm Lee, your personal Mental Health robot. What's your name? (Add @ before your name)")
    matches = getUserName()
    while True:
        if matches:
            global username
            username = matches
            print(f"Hello {username}! I'm here to help you.")
            print("If you have any questions about mental health, please don't hesitate to ask me.")
